...
const nomor_hp_yang_ngirim = "+6281393491334"
const nama_yang_ngirim = "Ari"
...
const kata = [
  `Selamat ulang tahun cintaku kasihku ${nama}, 🎂😘. Banyak kenangan indah terjalin bersamamu`,
  `Jaga kesehatan jangan suka melek malam, jangan suka maksain diri 🙃`,
  `Selalu tersenyum, tapi kalo ke cowok lain nggak. Tidak rela juga ${nama}ku ditengok²in cowo lain.`,
  `Jangan lupa di makan 🍰 nya, walau kue online heheh. Btw pengen beri kue asli huhu`,
  `Semoga selalu dijaga dan dirahmati Yang Maha Kuasa, selamat menjadi 19 tahun ${nama} cantikku cintaku istrikuuuuuuu 🥰. Seterusnya mohon bantuannya selalu, muachhhhhhh`
]
